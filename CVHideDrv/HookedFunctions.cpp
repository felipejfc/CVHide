...
)
{
		...
		ObjectInformation != NULL)
	{
		if (ObjectInformationClass == ObjectTypeInformation)
		{
			...
			{
				BACKUP_RETURNLENGTH();
				Type->TotalNumberOfObjects -= g_CVHide.NumberOfActiveDebuggers;
				Type->TotalNumberOfHandles -= g_CVHide.NumberOfActiveDebuggers;
				RESTORE_RETURNLENGTH();
			}
		...
		else if (ObjectInformationClass == ObjectTypesInformation)
		{
			...
			for (ULONG i = 0; i < TotalObjects; i++)
			{
				...
				{
					ObjectTypeInfo->TotalNumberOfObjects -= g_CVHide.NumberOfActiveDebuggers;
					ObjectTypeInfo->TotalNumberOfHandles -= g_CVHide.NumberOfActiveDebuggers;
				}
...
) 
{
		 ...
		 CreateFlags & THREAD_CREATE_FLAGS_BYPASS_PROCESS_FREEZE))
	{
		...
		if(g_CVHide.CurrentWindowsBuildNumber >= WINDOWS_10_VERSION_19H1)
...
{
	LogInfo("NtUserGetForegroundWindow");
...
PHOOK NtContinueHook;
PHOOK NtOpenProcessHook;
PHOOK NtQueryInformationThreadHook;
PHOOK NtQueryInformationProcessHook;
PHOOK NtQueryObjectHook;
PHOOK NtQuerySystemInformationHook;
PHOOK NtSetInformationThreadHook;
PHOOK NtCloseHook;
PHOOK NtGetContextThreadHook;
PHOOK NtSetContextThreadHook;
PHOOK NtSystemDebugControlHook;
PHOOK NtCreateThreadExHook;
PHOOK NtCreateFileHook;
PHOOK NtCreateProcessExHook;
PHOOK NtYieldExecutionHook;
PHOOK NtQuerySystemTimeHook;
PHOOK NtQueryPerformanceCounterHook;
PHOOK NtQueryInformationJobObjectHook;
PHOOK NtCreateUserProcessHook;
PHOOK NtGetNextProcessHook;
PHOOK NtOpenThreadHook;
PHOOK NtSetInformationProcessHook;

BOOLEAN UnhookNTSyscalls()
{
	std::array NtSyscallsToUnhook
	{
		SyscallInfo{0, "NtContinueEx", HookedNtContinue, (void**)&OriginalNtContinue, &NtContinueHook},
		SyscallInfo{0, "NtOpenProcess", HookedNtOpenProcess, (void**)&OriginalNtOpenProcess, &NtOpenProcessHook},
		SyscallInfo{0, "NtQueryInformationThread", HookedNtQueryInformationThread, (void**)&OriginalNtQueryInformationThread, &NtQueryInformationThreadHook},
		SyscallInfo{0, "NtQueryInformationProcess", HookedNtQueryInformationProcess, (void**)&OriginalNtQueryInformationProcess, &NtQueryInformationProcessHook},
		SyscallInfo{0, "NtQueryObject", HookedNtQueryObject, (void**)&OriginalNtQueryObject, &NtQueryObjectHook},
		SyscallInfo{0, "NtQuerySystemInformation", HookedNtQuerySystemInformation, (void**)&OriginalNtQuerySystemInformation, &NtQuerySystemInformationHook},
		SyscallInfo{0, "NtSetInformationThread", HookedNtSetInformationThread, (void**)&OriginalNtSetInformationThread, &NtSetInformationThreadHook},
		SyscallInfo{0, "NtClose", HookedNtClose, (void**)&OriginalNtClose, &NtCloseHook},
		SyscallInfo{0, "NtGetContextThread", HookedNtGetContextThread, (void**)&OriginalNtGetContextThread, &NtGetContextThreadHook},
		SyscallInfo{0, "NtSetContextThread", HookedNtSetContextThread, (void**)&OriginalNtSetContextThread, &NtSetContextThreadHook},
		SyscallInfo{0, "NtSystemDebugControl", HookedNtSystemDebugControl, (void**)&OriginalNtSystemDebugControl, &NtSystemDebugControlHook},
		SyscallInfo{0, "NtCreateThreadEx", HookedNtCreateThreadEx, (void**)&OriginalNtCreateThreadEx, &NtCreateThreadExHook},
		SyscallInfo{0, "NtCreateFile", HookedNtCreateFile, (void**)&OriginalNtCreateFile, &NtCreateFileHook},
		SyscallInfo{0, "NtCreateProcessEx", HookedNtCreateProcessEx, (void**)&OriginalNtCreateProcessEx, &NtCreateProcessExHook},
		SyscallInfo{0, "NtYieldExecution", HookedNtYieldExecution, (void**)&OriginalNtYieldExecution, &NtYieldExecutionHook},
		SyscallInfo{0, "NtQuerySystemTime", HookedNtQuerySystemTime, (void**)&OriginalNtQuerySystemTime, &NtQuerySystemTimeHook},
		SyscallInfo{0, "NtQueryPerformanceCounter", HookedNtQueryPerformanceCounter, (void**)&OriginalNtQueryPerformanceCounter, &NtQueryPerformanceCounterHook},
		SyscallInfo{0, "NtQueryInformationJobObject", HookedNtQueryInformationJobObject, (void**)&OriginalNtQueryInformationJobObject, &NtQueryInformationJobObjectHook},
		SyscallInfo{0, "NtCreateUserProcess", HookedNtCreateUserProcess, (void**)&OriginalNtCreateUserProcess, &NtCreateUserProcessHook},
		SyscallInfo{0, "NtGetNextProcess", HookedNtGetNextProcess,(void**)&OriginalNtGetNextProcess, &NtGetNextProcessHook},
		SyscallInfo{0, "NtOpenThread", HookedNtOpenThread, (void**)&OriginalNtOpenThread, &NtOpenThreadHook},
		SyscallInfo{0, "NtSetInformationProcess", HookedNtSetInformationProcess, (void**)&OriginalNtSetInformationProcess, &NtSetInformationProcessHook}
	};
	
	for (auto& syscallToHook : NtSyscallsToUnhook)
	{
		if (!SSDT::UnhookNtSyscall(*syscallToHook.Hook))
		{
			LogError("%s unhook failed", syscallToHook.SyscallName.data());
			return FALSE;
		}
		else {
			LogInfo("Unhooked %s", syscallToHook.SyscallName.data());
		}
...
BOOLEAN HookNtSyscalls()
{
	...
	if (g_CVHide.CurrentWindowsBuildNumber < WINDOWS_10_VERSION_20H1) NtSyscallsToHook[0].SyscallName = "NtContinue";
	...
	{
		if (!SSDT::HookNtSyscall(syscallToHook.SyscallNumber, syscallToHook.HookFunctionAddress, syscallToHook.OriginalFunctionAddress, *syscallToHook.Hook))
		{
			LogError("Failed to hook %s", syscallToHook.SyscallName);
			return FALSE;
		}
...
PHOOK NtUserBuildHwndListHook;
PHOOK NtUserFindWindowExHook;
PHOOK NtUserQueryWindowHook;
PHOOK NtUserGetForegroundWindowHook;
...
BOOLEAN UnhookWin32kSyscalls()
{
	std::array Win32kSyscallsToUnhook
	{
		SyscallInfo{0UL, "NtUserBuildHwndList", HookedNtUserBuildHwndList, (void**)&OriginalNtUserBuildHwndList, &NtUserBuildHwndListHook},
		SyscallInfo{0UL, "NtUserFindWindowEx", HookedNtUserFindWindowEx, (void**)&OriginalNtUserFindWindowEx, &NtUserFindWindowExHook},
		SyscallInfo{0UL, "NtUserQueryWindow", HookedNtUserQueryWindow, (void**)&OriginalNtUserQueryWindow, &NtUserQueryWindowHook},
		SyscallInfo{0UL, "NtUserGetForegroundWindow", HookedNtUserGetForegroundWindow, (void**)&OriginalNtUserGetForegroundWindow, &NtUserGetForegroundWindowHook},
		SyscallInfo{0UL, "NtUserGetThreadState", nullptr, nullptr},
	};
	if (g_CVHide.CurrentWindowsBuildNumber <= WINDOWS_7_SP1)
	{
		Win32kSyscallsToUnhook[0].HookFunctionAddress = HookedNtUserBuildHwndListSeven;
		Win32kSyscallsToUnhook[0].OriginalFunctionAddress = (void**)&OriginalNtUserBuildHwndListSeven;
	}

	for (auto& syscallToHook : Win32kSyscallsToUnhook)
	{
		if (!syscallToHook.HookFunctionAddress)
			continue;
		if (!SSDT::UnhookWin32kSyscall(syscallToHook.SyscallName.data()))
		{
			LogError("%s unhook failed", syscallToHook.SyscallName.data());
			return FALSE;
		}
...
BOOLEAN HookKiDispatchException()
{
	...
	const auto Pattern = g_CVHide.CurrentWindowsBuildNumber >= WINDOWS_11 ? "\x24\x00\x00\x41\xB1\x01\x48\x8D\x4C\x24\x00\xE8" : "\x8B\x00\x50\x00\x8B\x00\x58\x48\x8D\x4D\x00\xE8\x00\x00\x00\xFF\x8B\x55";
	const auto Mask = g_CVHide.CurrentWindowsBuildNumber >= WINDOWS_11 ? "x??xxxxxxx?x" : "x?x?x?xxxx?x???xxx";
	const auto Section = g_CVHide.CurrentWindowsBuildNumber >= WINDOWS_11 ? "PAGE" : ".text";
