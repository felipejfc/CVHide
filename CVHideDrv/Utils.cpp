...
{
	if (g_CVHide.CurrentWindowsBuildNumber <= WINDOWS_10_VERSION_THRESHOLD2)
	{
...
{
	if (g_CVHide.CurrentWindowsBuildNumber < WINDOWS_10_VERSION_REDSTONE2)
		return FALSE;
	else if (g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_REDSTONE2)
...
BOOLEAN GetOffsets() 
{	
	if (g_CVHide.CurrentWindowsBuildNumber >= WINDOWS_11)
	{
	...
	else if (g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_22H2 ||
		g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_21H1 || g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_21H2 ||
		g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_20H2 || g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_20H1)
	{
		NtapiOffsets.BypassProcessFreezeFlagOffset = 0x74;
	...
	else if (g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_19H2 || g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_19H1)
	{
		NtapiOffsets.BypassProcessFreezeFlagOffset = 0x74;
	...
	else if (g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_REDSTONE5)
	{
	...
	else if (g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_REDSTONE4)
	{
		NtapiOffsets.BypassProcessFreezeFlagOffset = 0;
		NtapiOffsets.ThreadHideFromDebuggerFlagOffset = 0x6d0;
		NtapiOffsets.ThreadBreakOnTerminationFlagOffset = 0x6d0;
	...
	else if (g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_REDSTONE3)
	{
		NtapiOffsets.BypassProcessFreezeFlagOffset = 0;
		NtapiOffsets.ThreadHideFromDebuggerFlagOffset = 0x6d0;
		NtapiOffsets.ThreadBreakOnTerminationFlagOffset = 0x6d0;
	...
	else if (g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_REDSTONE1)
	{
		NtapiOffsets.BypassProcessFreezeFlagOffset = 0;
	...
	else if (g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_THRESHOLD2)
	{
		NtapiOffsets.BypassProcessFreezeFlagOffset = 0;
	...
	else if (g_CVHide.CurrentWindowsBuildNumber == WINDOWS_10_VERSION_THRESHOLD1)
	{
		NtapiOffsets.BypassProcessFreezeFlagOffset = 0;
		NtapiOffsets.ThreadHideFromDebuggerFlagOffset = 0x6bc;
		NtapiOffsets.ThreadBreakOnTerminationFlagOffset = 0x6bc;
