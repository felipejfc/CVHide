...
HWND CreateTooltips(HWND hDlg)
{
    static const struct
    {
        ...
        },
        {
            ...
            L"This leads to a loss of control over the target.CVHide will save information which thread supposed to be hidden\r\n"
            ...
            L"CVHide will save information which thread has this flag set"
        },
        {
        ...
        },
        {
            ...
            L"can be used to detect debuggers. CVHide filters only debugger DebugObject references because debugged process\r\n"
        ...
        },
        {
            ...
            L"CVHide calls ZwQueryObject to check the validity of the handle."
        },
        {
        ...
        },
        {
            ...
            L"CVHide will hide process which was created by another hidden process."
        },
        {
        ...
        },
        {
            ...
            L"If checked CVHideDrv will clear all hardware breakpoints and restore them in NtContinue so\r\n"
        ...
        },
        {
            ...
            L"If checked CVHide will also hide process which was created by another hidden process."
        },
        {
